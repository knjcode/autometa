(function() {
  var HORIZONTAL_MARK, TEMPLATES_DIRS, VERTICAL_MARK, decodeCell, decodeCol, decodeRow, ejs, encodeCell, encodeCol, encodeRow, file_dir, fs, getTemplateFilePath, mapKey, moveCell, path, readExcelFile, registerTemplate, specified_template_id, splitCell, templates_dirs, xls, xlsx;
