(function() {
  var HORIZONTAL_MARK, TEMPLATES_DIRS, VERTICAL_MARK, decodeCell, decodeCol, decodeRow, ejs, encodeCell, encodeCol, encodeRow, fs, getCsvFilename, getEjsFilename, mapKey, moveCell, path, readExcelFile, registerTemplate, splitCell, templates_dirs, xls, xlsx;
