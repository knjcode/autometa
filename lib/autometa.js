(function() {
  var decodeCell, decodeCol, decodeRow, ejs, encodeCell, encodeCol, encodeRow, fs, getCsvFilename, getEjsFilename, mapKey, moveCell, path, readExcelFile, splitCell, xls, xlsx;
  ...
  mapKey = function(keymap, worksheet) {
    var cell, elementarray, i, key, nextcell, repcount, _i;
    for (key in keymap) {
      cell = keymap[key];
      if (worksheet["" + cell].w[0] === '*') {
