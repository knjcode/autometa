(function() {
  ...
  exports.generate = function(excelfile) {
    var csvfile, csvfilename, data, ejsfilename, element, ext, i, id, key, keymap, out, outputs, rowData, sheet, sheetnum, template, workbook, worksheet, _i, _j, _len, _ref, _ref1;
