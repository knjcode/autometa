(function() {
  var HORIZONTAL_MARK, TEMPLATES_DIRS, VERTICAL_MARK, decodeCell, decodeCol, decodeRow, ejs, encodeCell, encodeCol, encodeRow, fs, getCsvFilename, getEjsFilename, mapKey, moveCell, path, readExcelFile, splitCell, templates_dirs, xls, xlsx;
  ...
  exports.registerCsv = function(csvfile) {
    return console.log('registerCsv');
  };

  exports.registerEjs = function(ejsfile) {
